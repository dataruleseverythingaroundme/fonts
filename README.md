...
This GitHub Pages repository serves the Geist and Geist Mono web fonts used by Tellius HTML decks. The font files are licensed under the SIL Open Font License; see `Geist-OFL.txt`.
